...
const Card = ({
  ...
  const { card, addToQuantity, removeToQuantity } = useStore();
      ...
      >
        ...
        <div className=" relative">
          {card?.map((item) => (
            <div
              key={item.id}
              className=" shadow-md mt-4 py-2 px-3 border flex items-center justify-between"
            >
        ...
        <div className=" mt-6 border-t-2 pt-2 px-4 w-full">
          <div className=" flex items-center justify-between">
